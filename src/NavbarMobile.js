...
export function NavbarMobile({ as: _Component = _Builtin.NavbarWrapper }) {
  ...
  return (
    ...
    >
      <_Builtin.Block className="navbar-bg-copy" tag="div" />
      <_Builtin.Block className="navbar-container-copy" tag="div">
        <_Builtin.Link
          button={false}
          block="inline"
          options={{
        ...
        <_Builtin.NavbarButton className="rl_navbar5_menu-button" tag="div">
          <_Builtin.Block className="div-block-201" tag="div">
            <_Builtin.Block className="navbar-main-cta-wrap" tag="div">
              <_Builtin.Link
                className="button-main-nav"
                button={false}
                id="main-cta-nav"
                block="inline"
                options={{
            ...
            <_Builtin.Block className="nav-menu-vertical-divider" tag="div" />
        ...
        <_Builtin.NavbarMenu
          ...
          role="navigation"
        >
          <_Builtin.Block className="rl_navbar5_menu-left-copy" tag="div">
            <_Builtin.DropdownWrapper
              className="menu-item-with-link-1-copy"
              tag="div"
              delay={120}
              hover={true}
            >
              ...
              <_Builtin.DropdownList
                className="rl_navbar5_dropdown-list _2nd-copy"
                tag="nav"
              >
                <_Builtin.Block
                  className="navbar-expand-content-copy"
                  tag="div"
                >
                  <_Builtin.Block className="navbar-expand-r-copy" tag="div">
                    <_Builtin.Block className="nav-expand-top r" tag="div">
                      <_Builtin.Link
                    ...
                    <_Builtin.Block className="nav-expand-bottom" tag="div">
                      <_Builtin.Block
                        className="big-menu-category-title-wrap align-right"
                        tag="div"
                      >
                        <_Builtin.Block
                      ...
                      <_Builtin.Paragraph className="is--color-white70 align-right-d">
                        {
          ...
          <_Builtin.Block className="rl_navbar5_menu-right-copy" tag="div">
            <_Builtin.Link
